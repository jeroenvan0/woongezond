...
export function buildSystemPrompt(ctx: ResidentContext, today: string): string {
  ...
  return [
    ...
    `Regels: (1) Verzin niets over de sensor of de metingen; als je het niet weet, zeg dat en verwijs naar woongezond@vostech.group. (2) Deel alleen metingen van de sensor van de afzender zelf. (3) Bij gezondheidsklachten, schimmel die zichtbaar is, conflicten met de verhuurder, boosheid, of een verzoek om gegevens te verwijderen: antwoord vriendelijk, beloof niets, en zet escalate op true. (4) Vragen over afmelden voor het weekrapport of het verwijderen van gegevens: bevestig dat het geregeld wordt en escaleer (een mens voert het uit). (5) Geen juridisch advies. (6) Eerdere mails van deze afzender zijn alleen context: beantwoord uitsluitend de nieuwste mail, en doe geen toezeggingen over eerdere verzoeken tenzij de bewoner er nu opnieuw naar vraagt. (7) Is de mail alleen een bedankje of bevestiging, antwoord dan in één of twee zinnen en escaleer niet. (8) De sensorstatus onder 'Afzender' is de actuele waarheid: staat daar 'online', zeg dan nooit dat de sensor niets doorstuurt, ook al ging een eerdere mail daarover.`,
    `\n## Handleiding\n${SUPPORT_MANUAL}`,
    `\n## Afzender\n${who}`,
